...
describe "KingDta::DtazvSegments" do
  ...
  it "should return the proper T segment" do
    @dudes_dtazv_export.add_t(@dalai_lamas_booking).should == "0768T37050299EUR1326049634#{@date.strftime("%y%m%d")}00000000   0000000000MARKF1100  DE DALAI LAMAS BANK                                                      5TH AVENUE                         55323 LOS ANGELES                  DE DALAI LAMA                                                            BUSH-AVENUE 55                     445555 INDIA                                                                                             /GR1601101250000000012300695       EUR00000000000220250                                                                                                                                            00000000                         0013                                                              0                                                   00"
  end
